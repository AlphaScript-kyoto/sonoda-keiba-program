...
|------|-----|---------|------|--------|--------|--------|
| 2026/1-5 | 491 | **87.5%** | 95.7% | **76.7%** | 103.6% | 86.2% |
| 2026/1-3 | 168 | 83.4% | 99.2% | **61.7%** | 55.1% | 91.9% |
| 2026/4-5 | 323 | **89.5%** | 94.0% | **81.4%** | 129.2% | 83.1% |
...
- **2026-06 R分析反映済み:** `tuned_weights_style`（`last3_avg_finish`/`jockey_win_rate`/`horse_win_rate_track` 強化）、`bets.py`（◎25倍超単勝見送り、BOX穴50倍上限、穴1頭）
- **2026-06 R分析 phase2:** `04_segment_analysis.R`（堅荒・自信度・券種別）、`05_decile_extended.R`、`06_bet_like_roi.R`、`export_backtest_for_r.py`
- **未着手:**
